  ...
  <SceneWrapper>
    <StickyHeader style={{ paddingBottom: '20px' }}>
      <PageTitle>
        <div>
          <Title>
            <Icon size='36px' color='blue600' name='email' />
...
const InboxContainer = (props: Props) => {
  ...
  return rowDataR.cata({
    ...
    Success: (val) => (
      <Scene>
        <DispatchCard messageId='15' />
        <DispatchCard messageId='42' />
        <DispatchCard messageId='48' />
        <DispatchCard messageId='196' />
...
export default enhance(InboxContainer) as React.ComponentClass
